...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/skyscanner-backpack/pr-4153/plan.md
project: Skyscanner Backpack Design System
companion_spec: spec-example-backpack-nx.md
note: "Implementation plan for Nx migration. Shows how infrastructure changes are broken down. Internal references sanitized."
---

# Real-World Example: Infrastructure Implementation Plan

<!-- Real-world infrastructure plan from Backpack Nx migration (480 lines) -->
