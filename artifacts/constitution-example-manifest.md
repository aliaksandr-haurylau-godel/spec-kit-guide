...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/mnfst-manifest/constitution.md
project: Manifest Generator
domain: CLI Tools & Code Generation
constitution_version: 2.0.0
previous_version: 1.1.0
note: "MAJOR VERSION BUMP example. Shows POC → Production transition with added security/community standards."
---

<!--
  REAL-WORLD CONSTITUTION: Manifest Generator v2.0.0
  ===================================================
  
  Constitution for a CLI code generation tool, showing how constitutions evolve as
  projects mature from POC to production.
  
  **Constitution Version History:**
  
  **v1.0.0** (POC Phase)
  - Basic code quality principles (SOLID)
  - "DEFERRED FOR POC" markers on testing, performance, security
  - Minimal viable standards for proof-of-concept
  
  **v1.1.0** (Minor - POC refinements)
  - Added performance guidelines (still deferred for POC)
  - Enhanced documentation standards
  
  **v2.0.0** (MAJOR - MVP/Production transition - 2026-01-19)
  ...
  - **ENHANCED:** Full CI/CD requirements now active
  - Ratification date: 2025-12-22, Last amended: 2026-01-19
  - **Impact:** Templates compatible (already had testing sections)
  
  **Why MAJOR version?**
  - Removed entire sections (POC scope declarations)
  - Made previously-deferred requirements mandatory (breaking change for workflow)
  - Added 2 new constitutional articles
  - Fundamentally changed project maturity level (POC → Production)
  
  **Key Lesson:** Constitutions can start minimal (POC) and grow as projects mature.
  The SYNC IMPACT report tracks this evolution explicitly.
  
  Source: Internal project (sanitized for public documentation)
-->
