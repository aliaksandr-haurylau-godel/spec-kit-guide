...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/jetbrains-ideavim/branch-001-api-layer/tasks.md
project: JetBrains IdeaVim
companion_spec: spec-example-ideavim-api.md
companion_plan: plan-example-ideavim-api.md
note: "Task breakdown showing actionable steps derived from the plan. 271 lines of detailed work items."
---

<!-- Real-world task breakdown from IdeaVim API layer project -->
