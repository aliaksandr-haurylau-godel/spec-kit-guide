...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/skyscanner-backpack/constitution.md
project: Skyscanner Backpack Design System
domain: Design System & Component Library
constitution_version: 1.0.2
previous_version: 1.0.1
note: "Design system constitution with NON-NEGOTIABLE markers for critical standards. Shows patch-level evolution (template improvements)."
---

<!--
  REAL-WORLD CONSTITUTION: Backpack Design System v1.0.2
  =======================================================
  
  Constitution for Skyscanner's Backpack, an enterprise design system with 95+ component
  packages serving multiple products.
  
  **Constitution Version History:**
  
  **v1.0.0** (Initial)
  - Established component-first architecture
  - Naming conventions for 95+ packages
  - Apache 2.0 license headers (NON-NEGOTIABLE)
  
  **v1.0.1 → v1.0.2** (Patch - Template improvements)
  - Updated component name placeholders (BpkComponentName → Bpk[ComponentName])
  ...
  - **Impact:** All templates updated (✅ aligned)
  
  **Key Features:**
  - **NON-NEGOTIABLE markers** for critical requirements (license headers, naming)
  - Design system-specific articles (design tokens, component structure, Storybook patterns)
  - Modern Sass API requirements (@use syntax)
  - Comprehensive testing standards (unit, visual regression, accessibility)
  
  **Why PATCH version?** Only template/example improvements, no principle changes.
