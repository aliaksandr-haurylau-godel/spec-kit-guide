...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/jetbrains-ideavim/branch-001-api-layer/research.md
project: JetBrains IdeaVim
companion_spec: spec-example-ideavim-api.md
artifact_type: research
note: "FIRST research.md EXAMPLE in our guide! Shows K-numbered decision logs for complex architectural choices."
---
...
<!--
  ...
  This is a `research.md` file - an OPTIONAL artifact in Spec-Kit that documents complex
  design decisions and trade-offs during the specification phase.
  
  **When to create research.md:**
  - Multiple architectural approaches need evaluation
  - Complex API design decisions require documentation
  - Trade-offs and constraints need explicit reasoning
  - Team needs shared understanding of "why" before implementation
  
  **Structure Pattern (K-numbered):**
  Each major research question gets a "K" number (K1, K2, K3...) with:
  - Problem Statement: What needs to be decided?
  - Current State Analysis: What exists today?
  - Decision: What was chosen?
  - Rationale: Why this approach?
  
  **IdeaVim Example:** This research.md documents 6 major API design decisions (K1-K6):
  - K1: State update complexity
  - K2: Functional vs builder patterns
  - K3: API surface scope
  - K4: Compatibility strategy
  - K5: Documentation approach
  - K6: Testing validation
  
  Source: 418 lines from production IdeaVim project
-->
