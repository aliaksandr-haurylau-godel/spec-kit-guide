...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/skyscanner-backpack/pr-4153/spec.md
project: Skyscanner Backpack Design System
domain: Infrastructure & Tooling
complexity: Medium
type: Infrastructure Refactoring (Nx Migration)
note: "Real-world infrastructure spec. Demonstrates how Spec-Kit handles tooling changes vs feature development. Internal references sanitized."
---

# Real-World Example: Infrastructure Specification

<!--
  REAL-WORLD EXAMPLE: Infrastructure Specification
  =================================================
  
  This specification is from Skyscanner's Backpack design system, an enterprise-scale
  component library serving multiple products across Skyscanner.
  
  **Context:** Migration to Nx monorepo tooling requires project structure reorganization.
  This is NOT a user-facing feature - it's infrastructure work.
  
  **Notable Features:**
  - 355 lines covering infrastructure/tooling changes
  - "Clarifications" section with dated Q&A sessions
  - Strategic context explaining "why" (dependency graphs, caching, merge conflicts)
  - Effort/Complexity metadata: L (Large) effort, S (Small) complexity, 2-week estimate
  - References to internal docs (sanitized for this guide)
  
  **Why this example:** Shows Spec-Kit applies to non-feature work like tooling, migrations,
  and DevOps infrastructure. Different structure than feature specs.
  
  Source: https://github.com/Skyscanner/backpack (public open-source, internal links sanitized)
-->
...
Reference: [Internal Documentation Link]
==============================================================================
-->
...
Per [Internal Documentation Link]:
...
- **Nx Adoption One Pager**: [Internal Documentation Link]
- **Nx Initialization Spec**: `specs/nx-initialization/spec.md`
- **TypeScript Monorepos Standard**: [Internal Documentation Link]
