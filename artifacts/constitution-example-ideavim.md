...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/jetbrains-ideavim/constitution.md
project: JetBrains IdeaVim
domain: IDE Plugin Development
constitution_version: 1.2.2
previous_version: 1.2.1
note: "Real-world constitution from open-source project. Demonstrates SYNC IMPACT version tracking and evolution."
---

<!--
  REAL-WORLD CONSTITUTION: IdeaVim v1.2.2
  ========================================
  
  This is the actual constitution governing the IdeaVim project, a Vim emulation plugin
  for IntelliJ IDEA with 10,000+ stars on GitHub.
  
  **Constitution Version History (summarized):**
  
  **v1.0.0** (Initial - date unknown)
  - Established 8 core articles
  - Vim compatibility, platform integration, code quality standards
  
  **v1.2.0** (Minor update)
  - Added Article VII: Architecture Decision Records
  - Added Article VI: Documentation Goals
  
  **v1.2.1** (Minor update - date unknown)
  - Refined commit clarity standards
  - Enhanced testing requirements
  
  **v1.2.2** (Current - 2026-01-30)
  ...
  - **Impact:** No template changes required (Constitution Check verified compatibility)
  
  **SYNC IMPACT Pattern:**
  Notice the frontmatter comment (lines 1-19) tracking:
  - Version change (1.2.1 → 1.2.2)
  - Modified sections
  - Template compatibility (✅ all compatible)
  - Follow-up TODOs (none)
  
  This pattern ensures constitution changes don't break existing templates and agents.
  
  **Key Articles:**
  - I. Vim Compatibility (IDE-First) - Unique to IDE plugins
  - III. vim-engine Separation - Multi-product architecture
  - VIII. Trunk-Based Development - Recently updated to prefer feature branches
