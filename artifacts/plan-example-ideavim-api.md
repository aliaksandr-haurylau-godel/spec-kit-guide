...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/jetbrains-ideavim/branch-001-api-layer/plan.md
project: JetBrains IdeaVim
companion_spec: spec-example-ideavim-api.md
note: "Implementation plan for API layer specification. Shows how complex architectural changes are broken down into phased delivery."
---

<!-- Real-world implementation plan from IdeaVim API layer project (307 lines) -->
