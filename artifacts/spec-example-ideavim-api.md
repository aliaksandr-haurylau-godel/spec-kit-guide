...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/jetbrains-ideavim/branch-001-api-layer/spec.md
project: JetBrains IdeaVim
domain: IDE Plugin Development
complexity: High
type: API Design & Large Refactoring
note: "Real-world example from production open-source project. Demonstrates complex architectural specification with multiple user stories and acceptance criteria."
---

<!-- 
  REAL-WORLD EXAMPLE: IdeaVim API Layer Specification
  ====================================================
  
  This is an authentic specification from the JetBrains IdeaVim project, an open-source
  Vim emulation plugin for IntelliJ-based IDEs with 10,000+ GitHub stars.
  
  **Context:** The IdeaVim team needed to establish a clean API boundary for their extension
  system, allowing external plugins to depend on a stable interface while the core team
  refactors internal code freely.
  
  **Notable Features:**
  - 249 lines covering a complex, multi-month refactoring
  - Prioritized user stories (P1, P2, P3)
  - Independent testing criteria for each story
  - Clear acceptance scenarios using Given/When/Then format
  
  **Why this example:** Shows how Spec-Kit handles large, architectural changes that impact
  multiple teams (internal devs + external plugin developers).
