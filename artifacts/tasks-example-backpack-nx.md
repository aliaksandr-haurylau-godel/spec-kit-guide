...
derived_from: raw_data/2026-02-15-real-world-spec-kit-artifacts/skyscanner-backpack/pr-4153/tasks.md
project: Skyscanner Backpack Design System
companion_spec: spec-example-backpack-nx.md
companion_plan: plan-example-backpack-nx.md
note: "Task breakdown for Nx migration. 261 lines of infrastructure work items."
---

# Real-World Example: Infrastructure Task List

<!-- Real-world infrastructure tasks from Backpack Nx migration -->
...
- **Production Standards**: [Internal Documentation Link]
